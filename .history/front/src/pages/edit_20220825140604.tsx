...
const Edit= (props: Props) => {
  const [name, setName] = useState<string>(`${props.profiles[0].title}`);
  const [occupation, setOccupation] = useState<string>(`${props.profiles[0].description}`);
  const [introduction, setIntroduction] = useState<string>(props.profiles[0].categoryId);
  const [twitter_id, setTwitter_id] = useState<string>(props.profiles[0].categoryId);
  const [github_id, setGithub_id] = useState<string>(props.profiles[0].categoryId);
  const [email, setEmail] = useState<string>(props.profiles[0].categoryId);
